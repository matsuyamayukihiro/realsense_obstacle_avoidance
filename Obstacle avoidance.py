...
try:
    while True:
        ...
        # 右側判定
        if 255 != bg_removed_R[50:430, 0:170]:  # 前判定ゾーンで監視
            dataR = 11  # 止まるモード

        elif 255 != bg_removed_R[50:430, 170:640]:  # 左判定ゾーンで監視
            dataR = 33  # "右モード
        else:
            dataR = 44  # 直進モード

        # 左側判定
        if 255 != bg_removed_L[50:430, 470:640]:  # 前判定ゾーンで監視
            dataL = 11  # 止まるモード

        elif 255 != bg_removed_L[50:430, 0:470]:  # 引数1 y座標  引数2 x座標
            dataL = 22  # 左モード
        ...
        elif dataL == 22:  # 引数1 y座標  引数2 x座標
            print("turn Left")
            data = 'turn Left'

        elif dataR == 33:  # 左判定ゾーンで監視
            print("turn Light")
            data = 'turn Light'
